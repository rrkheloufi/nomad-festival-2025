...
const artists: Artist[] = [
  {
    ...
    description:
      "Un voyage sonore unique mêlant électro expérimentale et textures ambient.",
  },
  {
    name: "Glenn B",
    artist: "Glenn B",
    ...
    description:
      "Des sets house progressifs qui vous transportent dans un univers hypnotique.",
  },
  {
    name: "Limace",
    artist: "Limace",
    ...
    description:
      "Un rock alternatif puissant et mélodique qui ne laisse personne indifférent.",
  },
  {
    ...
    description:
      "Un battle DJ set explosif entre deux artistes aux univers complémentaires.",
  },
  {
    name: "Harry & Emma",
    artist: "Harry & Emma",
    ...
    description:
      "Un duo folk acoustique authentique aux harmonies vocales envoûtantes.",
  },
  {
    name: "Clément Serra",
  ...
  },
  {
    ...
    description:
      "Une fusion explosive entre rock, funk et influences world music.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Un jazz contemporain innovant qui repousse les frontières du genre.",
  },
  {
    name: "Pierre Albarn",
  ...
  },
  {
    ...
    description:
      "Des paysages sonores ambient qui invitent au voyage intérieur.",
  },
  {
    name: "Fafa & Boubou",
    artist: "Simon Griffault",
            ...
            {selectedArtist && (
              ...
              >
                ...
                >
                  ...
                  <div className="p-8">
                    <h2
                      className="text-3xl font-bold mb-2 drop-shadow-glow"
