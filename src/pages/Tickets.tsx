...
const tickets = [
  ...
  },
  {
    ...
    features: ["Accès aux concerts du jour", "Accès aux ateliers du jour"],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
            ...
            {tickets.map((ticket) => (
              ...
              >
                <div className="flex-grow">
                  <h2 className="text-2xl font-bold text-festival-primary mb-2">
                    {ticket.name}
                  </h2>
                  <p className="text-3xl font-bold text-festival-dark mb-4">
                    {ticket.price}
                  </p>
                  <p className="text-festival-dark mb-6">
                    {ticket.description}
                  </p>
                  <ul className="space-y-2 mb-8">
                    {ticket.features.map((feature, index) => (
                      <li
                        key={index}
                        className="text-festival-dark flex items-center"
                      >
          ...
          <div className="backdrop-blur-sm rounded-lg p-8">
            ...
            <ul className="text-md space-y-4 text-festival-dark text-lg">
